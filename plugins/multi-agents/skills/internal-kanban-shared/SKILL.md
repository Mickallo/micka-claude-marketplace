...
|--------|--------|------------------------|-------|
| Req | `todo` | User | - |
| Plan | `plan` | `multi-agents:Planner` | opus |
| Review Plan | `plan_review` | `multi-agents:Critic` | sonnet |
| Impl | `impl` | `multi-agents:Builder` → `multi-agents:Shield` | opus → sonnet |
| Review Impl | `impl_review` | `multi-agents:CodeReview` (mode kanban) | opus |
| Test | `test` | `multi-agents:Ranger` | sonnet |
| Done | `done` | - | - |
...
|----------|-------|-------|-----------|
| `Planner` | `multi-agents:Planner` | `opus` | `plan`, `decision_log`, `done_when` |
| `Critic` | `multi-agents:Critic` | `sonnet` | `plan_review_comments` |
| `Builder` | `multi-agents:Builder` | `opus` | `implementation_notes` |
| `Shield` | `multi-agents:Shield` | `sonnet` | `implementation_notes` (append) |
| `Inspector` | `multi-agents:CodeReview` | `opus` | `review_comments` |
| `Ranger` | `multi-agents:Ranger` | `sonnet` | `test_results` |
